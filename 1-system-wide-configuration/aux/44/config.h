 ...
 */
static char *font = "FONT_NAME:pixelsize=FONT_SIZE:antialias=true:autohint=true";
static char *font2[] = { "FONT_NAME:pixelsize=FONT_SIZE:antialias=true:autohint=true" };
