...
print_message "Installing i3-gaps, i3status, dmenu..."
install_official_packages i3-gaps i3status dmenu
...
print_message "Installing termite, dunst, conky..."
install_official_packages termite dunst conky
